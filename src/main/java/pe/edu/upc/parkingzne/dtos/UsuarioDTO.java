...
public class UsuarioDTO {
    ...
    @NotNull(message = "El nombre del usuario debe ser obligatorio")
    private String nombre;
    @NotNull(message = "Los apellidos del usuario debe ser obligatorio")
    private String apellidos;
    @NotNull(message = "La fecha de nacimiento del usuario debe ser obligatorio")
    ...
    @NotNull(message = "El username del usuario debe ser obligatorio")
